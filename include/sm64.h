...
#ifdef AVOID_UB
#define GET_HIGH_U16_OF_64(var) ((u16)((var) >> 16))
#define GET_HIGH_S16_OF_64(var) ((s16)((var) >> 16))
#define GET_LOW_U16_OF_64(var) ((u16)((var) & 0xFFFF))
#define GET_LOW_S16_OF_64(var) ((s16)((var) & 0xFFFF))
#define SET_HIGH_U16_OF_64(var, x) ((var) = ((var) & 0xFFFF) | ((x) << 16))
...
#define SET_HIGH_S16_OF_64(var, x) ((((s16 *)&(var))[0]) = (x))
#endif
